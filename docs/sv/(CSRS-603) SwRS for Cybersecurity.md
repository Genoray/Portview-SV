...
| No. | Risk | RS (`SRS-603`) | SDS (`SDS-603`) | V&V (`TP-603`) |
| --- | --- | --- | --- | --- |
...
Refer to Clause 12, Risk Analysis Table (FMEA) in the Risk Management Report. See also `FMEA-603` Portview Risks FMEA.
...
See section 5.1 Cybersecurity Essentials Checklist in this document and Clause 12, Risk Analysis Table (FMEA) in the Risk Management Report. See also `FMEA-603` Portview Risks FMEA.
...
The maintenance planning activities are performed in the software validation maintenance process in accordance with IEC 62304:2015. Refer to `SV-603-02` Section 11 for the full maintenance and problem-resolution process.
...
Security patches follow the change-control and verification process defined in `SV-603-02` Section 11.2. SOUP components (Windows SDK, DCMTK, Qt) are monitored for end-of-life advisories and patched according to the same priority scheme.
