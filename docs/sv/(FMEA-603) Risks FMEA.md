# (FMEA-603) Portview Risks FMEA

Document ID: `FMEA-603`
Product: `Portview`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-001` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-012` |
| `FMEA-002` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-013` |
| `FMEA-003` | `1` | `1` | `1` | `1` | `1` | `yes` | `SystemTR-603` / `SYSP-007` |

### 4.2 Version And Audit

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-004` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-035`; Cybersecurity no 8 |
| `FMEA-005` | `1` | `1` | `1` | `1` | `1` | `yes` | `SystemTR-603` / `SYSP-007`; Cybersecurity no 3 |

### 4.3 Data Security

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-006` | `2` | `2` | `4` | `1` | `2` | `yes` | Cybersecurity no 2; `TR-603` / `ITP-034`; `NSE-603` #9 |

### 4.4 Image Processing And Calibration

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-007` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-013` to `ITP-021` |
| `FMEA-008` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-008` |

### 4.5 Device And Driver

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-009` | `1` | `1` | `1` | `1` | `1` | `yes` | `SystemTR-603` / `SYSP-007` |
| `FMEA-010` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-007` |
| `FMEA-015` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-007` to `ITP-012` |

### 4.6 Output And Communication

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-011` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-029` |
| `FMEA-012` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-006`, `ITP-029` |
| `FMEA-013` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-028`, `ITP-030` |
| `FMEA-014` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-013` to `ITP-021` |

### 4.7 Annotation

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-016` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-022` to `ITP-026` |

### 4.8 Patient Management

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-017` | `1` | `2` | `2` | `1` | `1` | `yes` | `TR-603` / `ITP-002`, `ITP-004`; Cybersecurity no 1, 7 |
| `FMEA-018` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-004`; Cybersecurity no 1, 7 |
| `FMEA-019` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-002`, `ITP-004`; Cybersecurity no 1, 7 |
| `FMEA-020` | `1` | `1` | `1` | `1` | `1` | `yes` | `TR-603` / `ITP-002`; Cybersecurity no 1, 7 |

### 4.9 Sensor Malfunction

| ID | S | O (pre) | RP (pre) | O (post) | RP (post) | Acceptable | Verification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `FMEA-021` | `2` | `2` | `4` | `1` | `2` | `yes` | `TR-603` / `ITP-008`; `SystemTR-603` / `SYSP-002` |

## 5. Cybersecurity Risk Integration

The following FMEA items have cybersecurity-related controls that are also addressed in `CSRS-603` (SwRS for Cybersecurity). This cross-reference ensures that functional-safety FMEA and cybersecurity risk management are integrated.
...
The cybersecurity essentials checklist in `CSRS-603` Section 5.1 provides the detailed control requirements and verification mapping for these items. Network security enclosure testing (`NSE-603`) provides additional evidence for FMEA-006.
