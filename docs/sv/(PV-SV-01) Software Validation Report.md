...
| `PV-SV-02` Software Development Planning | Development planning reference |
| `PV-SV-03` Software High Level Design | Architecture reference |
| `PV-SV-04` Software Verification Plan | Verification planning reference |
| `PV-SV-05` Software Verification Report | Verification result reference |
| `PV-TM-01` Traceability Matrix | Requirement and risk traceability reference |
| `PV-CSRS-01` SwRS for Cybersecurity | Cybersecurity control baseline |
...
| --- | --- |
| Development planning | `PV-SV-02` Software Development Planning |
| High-level design | `PV-SV-03` Software High Level Design |
| Requirement definition | `PV-RS-01` RS for Portview, `PV-SRS-01` SwSRS for Portview |
| Design specification | `PV-SDS-01` SwSDS for Portview |
| Traceability | `PV-TM-01` Traceability Matrix |
| Verification planning | `PV-SV-04` Software Verification Plan |
| Verification execution | `PV-STP-01` SwSTP for Portview, `PV-STR-01` SwSTR-Z01 for Portview, `PV-TR-01` SwTR-Z01 for Portview, `PV-SYSTR-01` SystemTR-Z01 |
| Cybersecurity controls | `PV-CSRS-01` SwRS for Cybersecurity, `PV-NSE-01` Network Security Enclosure |
...
| Topic | Summary |
| --- | --- |
| Software development planning | Documented in `PV-SV-02` |
| Software requirements and architecture | Documented in `PV-SV-03` and controlled requirement specifications |
| Traceability | Maintained through `PV-TM-01` and linked validation records |
| Verification planning and execution | Covered by `PV-SV-04`, `PV-SV-05`, and released unit/integration/system records |
...
| --- | --- |
| Software development planning | Controlled planning is documented in `PV-SV-02` |
| Software requirements | Requirement inputs are maintained through `PV-RS-01` and `PV-SRS-01` |
| Architecture and design | Architecture and decomposition are documented in `PV-SV-03` and `PV-SDS-01` |
| Verification planning | Verification planning and acceptance logic are documented in `PV-SV-04` |
| Verification results | Released execution outcomes are summarized in `PV-SV-05` and related procedure/result records |
| Risk and anomaly disposition | `PV-FMEA-01`, `PV-CSRS-01`, `PV-NSE-01`, and anomaly status are reviewed as part of validation closure |
...
| Cybersecurity control baseline | `PV-CSRS-01` SwRS for Cybersecurity |
| Cybersecurity-focused verification | `PV-NSE-01` Network Security Enclosure |
| Requirement and result linkage | `PV-TM-01` Traceability Matrix |

- `FR-xxx` risk items in `PV-FMEA-01` should remain traceable to requirements and released verification records.
- cybersecurity controls in `PV-CSRS-01` should remain linked to verification and residual-risk review.
...
| --- | --- |
| Software development planning | `PV-SV-02` Software Development Planning |
| Software safety classification | `PV-SV-01` Software Validation Report |
| Software requirements analysis | `PV-RS-01`, `PV-SRS-01`, and `PV-TM-01` traceability records |
| Software architectural design | `PV-SV-03` Software High Level Design |
| Software detailed design and implementation | `PV-SDS-01` and controlled build and implementation records |
| Software verification | `PV-SV-04`, `PV-SV-05`, and released procedure/result records |
| Software risk management | `PV-FMEA-01`, `PV-CSRS-01`, `PV-NSE-01`, and related risk-management files |
| Software configuration management | `PV-SV-02` planning records and controlled configuration items |
