...
- `SystemTP-603` [SystemTP-Z01]((SystemTP-603) SystemTP.md)
...
| Governing procedure | `SystemTP-603` |
...
The result set is aligned to the `SYSP-xxx` system procedure structure defined in `SystemTP-603`.
...
- system-result references in `SV-603-05` [Software Verification Report](../sv/(SV-603-05) Software Verification Report.md)
- lifecycle evidence statements in `SV-603-01` [Software Validation Report](../sv/(SV-603-01) Software Validation Report.md)
